// Transcrypt'ed from Python, 2021-02-03 19:53:41
var datetime = {};
var math = {};
var time = {};
...
export var create_gpx = function (list_of_lap_times) {
	...
	for (var lap_time of list_of_lap_times) {
		var mins = int (list_of_lap_times.__getslice__ (0, 2, 1));
		var secs = int (list_of_lap_times.__getslice__ (3, 5, 1));
		var millis = int (list_of_lap_times.__getslice__ (6, 8, 1));
